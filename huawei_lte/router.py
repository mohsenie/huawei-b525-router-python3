...
class Ethernet(RouterObject):
    ...
    def set_ppoe_dynamic(self, config):
        """The system can connect to the network in two ways: using the user name and password provided by your ISP
        or obtaining an IP address automatically """
...
class B525Router(object):
    ...
    def __login(self):
        ...
        client_proof = crypto.get_client_proof(self.clientnonce, servernonce, self.__password, salt, iterations).decode(
            'UTF-8')
